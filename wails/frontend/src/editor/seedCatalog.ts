...
import type { DropPoolDef, ItemDef, JobDef, QuestDef, SkillDef } from "./contentCatalogs";
import type { MapPrefab } from "./prefabs";
import dropSeeds from "./seeds/drops.json";
...
export const DEFAULT_DROP_CATALOG = dropSeeds as DropPoolDef[];
