...
export function JobsEditorPage({ items, skills, onItemsChange, status, error, onStatus }: Props) {
    ...
    <CatalogEditorShell
      ...
      detailSections={(job, onChange) => [
        ...
        },
        {
          id: "tree",
          label: "Skill tree",
          content: <JobSkillTreeInspector draft={job} skills={skills} onChange={onChange} />,
        },
      ]}
    />
  );
