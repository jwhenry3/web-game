...
var jobAbilityTrees = map[JobID][]jobAbility{
	...
	JobBRW: {
		...
		{Suffix: "fluctus", Name: "Combo Flow", Desc: "Passive: physical skill cooldowns are reduced while a combo stack is high.", Prereq: 3,
			Passive: &PassiveEffect{SkillTypes: []SkillAspect{AspectPhysical}, CooldownReduction: 0.25, MinComboStack: 2}},
	},
	// Melee DPS — axe
	JobRVR: {
		...
		{Suffix: "tempestas_ferri", Name: "Iron Storm", Desc: "A storm of axe blows.", MPCost: 15, Power: 3.2, Prereq: 1, CooldownMs: 2500},
		{Suffix: "impetus", Name: "Heavy Momentum", Desc: "Passive: physical skill effects are increased by 10%.", Prereq: 3,
			Passive: &PassiveEffect{SkillTypes: []SkillAspect{AspectPhysical}, EffectMultiplier: 0.10}},
	},
	...
	JobLNC: {
		...
		{Suffix: "saltus_maximus", Name: "Crash Dive", Desc: "Vanish upward, then crash down.", MPCost: 15, Power: 3.1, Prereq: 1, Ranged: true, CooldownMs: 2500},
		{Suffix: "peritia_hastae", Name: "Spear Mastery", Desc: "Passive: ranged skill effects are increased by 10%.", Prereq: 3,
			Passive: &PassiveEffect{SkillTypes: []SkillAspect{AspectRanged}, EffectMultiplier: 0.10}},
	},
	// Melee DPS — katana
	JobRON: {
		...
		{Suffix: "finis", Name: "Finishing Stance", Desc: "Passive: physical skill cooldowns are reduced against targets below 30% HP.", Prereq: 3,
			Passive: &PassiveEffect{SkillTypes: []SkillAspect{AspectPhysical}, CooldownReduction: 0.30, TargetHPBelow: 0.30}},
	},
	// Scout DPS — dagger
	JobCUT: {
		...
		{Suffix: "dolus_finis", Name: "Feint Thrust", Desc: "A deceptive finishing thrust.", MPCost: 13, Power: 2.9, Prereq: 1, CooldownMs: 2000},
		{Suffix: "opportunus", Name: "Opportunist", Desc: "Passive: physical skill effects are increased against targets below 30% HP.", Prereq: 3,
			Passive: &PassiveEffect{SkillTypes: []SkillAspect{AspectPhysical}, EffectMultiplier: 0.15, TargetHPBelow: 0.30}},
	},
	// Magic DPS — staff
	JobHEX: {
		...
		{Suffix: "ignis_maius", Name: "Inferno", Desc: "Unleash the brand as a roaring inferno.", MPCost: 16, Power: 3.3, Prereq: 2, Magic: true, CooldownMs: 3000},
		{Suffix: "attunement", Name: "Arcane Attunement", Desc: "Passive: magic skill effects are increased by 12%.", Prereq: 3,
			Passive: &PassiveEffect{SkillTypes: []SkillAspect{AspectMagic}, EffectMultiplier: 0.12}},
	},
	// Healer — wand
	JobSAN: {
		...
		{Suffix: "meditatio", Name: "Sacred Mending", Desc: "Passive: healing skill effects are increased by 15%.", Prereq: 3,
			Passive: &PassiveEffect{SkillTypes: []SkillAspect{AspectHeal}, EffectMultiplier: 0.15}},
	},
	// Support — wand
	JobCAN: {
		...
		{Suffix: "resonantia", Name: "Resonant Hymn", Desc: "Passive: buff skill effects are increased by 15%.", Prereq: 3,
			Passive: &PassiveEffect{SkillTypes: []SkillAspect{AspectBuff}, EffectMultiplier: 0.15}},
	},
}
