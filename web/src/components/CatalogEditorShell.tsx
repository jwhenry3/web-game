...
export type { CatalogTableColumn, CatalogTableFilter, CatalogDetailSection, CatalogViewTab } from "./CatalogTablePanel";
export { CatalogTabbedEditor, CatalogTableView } from "./CatalogTablePanel";
...
export function CatalogEditorShell<T extends { id: string; name: string }>({
  ...
  const [viewTab, setViewTab] = useState<CatalogViewTab>("catalog");
  ...
  return (
    <div className="map-editor-entities-shell">
      ...
      <div className="map-editor-layout map-editor-layout--catalog-tabbed">
        <CatalogTabbedEditor
          listTitle={listTitle}
          items={items}
          columns={columns}
